...
const api_routes = {
  ...
  admin: {
    ...
    fetch_campaign_settlement_summary: `/admin/campaign-settlement-summary`,
    fetch_campaign_settlement_datatable: `/admin/campaign-settlement-table`,
    post_campaign_settlement_transfer: `/admin/campaign-settlement-transfer`,
