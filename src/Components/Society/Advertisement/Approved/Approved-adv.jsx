...
const ApprovedTable = ({ activeTab, data }) => {
    ...
    <div className="card border-0 p-3 mx-4 my-3">
        ...
        <tbody>
          {data?.map((ad, index) => (
            <tr key={ad.id}>
              ...
              <td>{ad.campaignId}</td>
              <td>{ad.date}</td>
              <td>Mplussoft Digital Marketing 2025 </td>
              <td>Brand Promotions</td>
              <td>{ad.type}</td>
              <td className="text-center">
                <img src="/view.svg" onClick={() => navigate("/society/advertisement/approved-view")} style={{ cursor: "pointer" }}/>
              </td>
            </tr>
          ))}
        </tbody>
      ...
      <Row className="align-items-center">
        ...
        <div className="pagination-container custom-label">
            <button className="pagination-btn custom-label">Previous</button>
