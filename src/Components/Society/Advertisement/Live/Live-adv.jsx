...
const LiveTable = ({ activeTab, data }) => {
  ...
  return (
    <div className="card border-0 p-3 mx-4 my-3">
      ...
      <Row className="d-flex justify-content-between">
        <Col md={4} className="d-flex align-items-center custom-label fw-medium mt-2 mt-md-0">
          ...
          {data?.map((ad, index) => (
            <tr key={ad.id}>
              ...
              <td className="text-center">
                <img src="/view.svg" onClick={() => navigate("/society/advertisement/live-view")} style={{ cursor: "pointer" }}/>
              </td>
            </tr>
          ))}
        </tbody>
